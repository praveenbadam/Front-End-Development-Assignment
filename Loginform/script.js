document.getElementById('loginForm').addEventListener('submit', async function (e) {
  ...
  if (valid) {
      //  if "Remember Me" is checked then Save login info
      if (rememberMe) {
      ...
      try {
          ...
          if (response.ok) {
              ...
              apiMessage.style.fontSize = '16px'
          } else {
...
// For checking if the user info exists in localStorage 
